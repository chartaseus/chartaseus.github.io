...
title: Petunjuk Teknis Google Drive
description: Hal-hal yang perlu diketahui tentang Google Drive di Google Workspace untuk mempermudah kolaborasi dengan tim
...
publish: false
---
# Panduan Penggunaan Google Drive di Google Workspace

_untuk mengelola file Office dan Google Docs_

# Akses Google Drive

Buka [drive.google.com](http://drive.google.com) lalu login dengan akun email kerja atau dengan SSO perusahaan.
...
Ada dua lokasi penyimpanan dalam Google Drive di GoogleWorkspace:

1. Ruang penyimpanan pribadi di **My Drive (Drive Saya)** dan
2. Akses ke beberapa ruang penyimpanan bersama (yang dapat dipisahkan berdasarkan tim atau proyek) di **Shared Drives (Drive Bersama)**
...
Ada dua format dokumen *office* (teks-spreadsheet-presentasi) yang disimpan di Google Drive lab APS:
