...
* Tidak ada orang yang langsung memahami komputer sejak lahir.
...
* Saat akhirnya meminta bantuan Anda, mereka mungkin sudah mencoba beberapa cara. Alhasil, komputer mereka mungkin berada dalam kondisi yang aneh. Ini bukan salah mereka.
...
* Tujuan utama Anda bukan untuk menyelesaikan masalah mereka. Tujuan utama Anda adalah membantu mereka selangkah lebih mampu dalam menyelesaikan masalah secara mandiri. Jadi, sarankan mereka untuk mencatat.
...
Setelah meyakinkan diri akan hal-hal tersebut, Anda akan cenderung lebih mudah mengikuti beberapa aturan penting:

* Jangan ambil alih kibor. Biarkan mereka yang mengetik semuanya, walaupun dengan begitu akan lebih lambat, dan walaupun Anda harus menunjukkan semua tombol kibor yang harus ditekan. Itu satu-satunya cara mereka akan belajar dari interaksi kalian.
* Cari tahu apa yang sebenarnya ingin mereka lakukan. Adakah pendekatan lain untuk itu?
* Patuhi simbolisme interaksi. Lebih jelasnya, cobalah untuk tidak berdiri lebih tinggi. Jika mungkin, berjongkoklah agar posisi mata Anda berada sedikit di bawah posisi mereka. Ketika mereka melihat ke arah komputer, lihatlah ke arah komputer. Ketika mereka melihat ke arah Anda, lihat balik ke arah mereka.
* Jika sesuatu benar, tunjukkan bagaimana mereka bisa tahu bahwa itu benar.
* Perhatikan seberapa abstrak bahasa Anda. Contohnya, “Masuk ke editor” adalah abstrak sedangkan “Tekan tombol ini” itu konkret.
  Jangan mengatakan sesuatu yang tidak akan mereka pahami. Teruslah sesuaikan bahasa Anda ke arah kalimat-kalimat konkret hingga mereka mulai paham, kemudian perlahan kembali ke arah abstraksi asalkan bisa mereka ikuti.

  Ketika merancang pekerjaan mandiri (“ketika komputer jadi begini dan begitu, kamu perlu mengecek ini dan itu”), pastikan lagi bahwa Anda menggunakan bahasa dengan derajat abstraksi yang tepat untuk pengguna tersebut saat ini.
...
Diterjemahkan oleh [Fatiya](https://chartaseus.dev) dari “How to help someone use a computer." [_The Network Observer_](https://pages.gseis.ucla.edu/faculty/agre/tno/may-1994.html#how) 1(5), Mei 1994.